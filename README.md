...
## Дистанционная сдача
### Правила
- Сдать дистанционно можно только только через fork данного git репозитория;
...
### Тестирование
[Makefile](./examples/Lab1/Makefile) это файл, который должен быть в любой дистанционно сдаваемой лабе. Его вы берете за основу своего Makefile и редактируете необходимые пункты, а не переписываете все с нуля. Всего в нем 3 обязательные команды: </br>
1. Сборка всех .cpp файлов в исполняемые
    ```bash
    make
    ```
