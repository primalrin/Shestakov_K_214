...
## Дистанционная сдача
### Правила
- Сдать дистанционно можно только только через fork данного git репозитория в формате <фамилия>\_<1 буква имени>\_<группа>;
...
### Тестирование
[Makefile](./examples/Lab1/Makefile) это пример файла, который должен быть в любой дистанционно сдаваемой лабе. Всего в нем 3 обязательные команды: </br>
